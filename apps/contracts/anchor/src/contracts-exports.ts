...
export function getContractsProgram(provider: AnchorProvider, address?: PublicKey) {
  return new Program({ ...ContractsIDL, address: address ? address.toBase58() : ContractsIDL.address } as Contracts, provider)
}
